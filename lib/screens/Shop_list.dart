...
class Shop_list extends StatefulWidget {
  ...
  @override
  State<Shop_list> createState() => _Screen2State();
}

class _Screen2State extends State<Shop_list> {
  final List<Map<String, dynamic>> shops = [
    ...
    {'name': 'Shreeram Stores', 'location': 'Thane', 'lat': 19.21319881667652, 'lon': 72.9548863248078, 'ratings': '150'},
